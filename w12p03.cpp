...
class osoba //klasa czysto absrtakcyjna - interfejs
{
public:
...
public:
    student(string Imie = "", string Nazwisko = "", string Kierunek = "Informatkia", string Uczelnia = "UTH Rad.")
        : imie(Imie), nazwisko(Nazwisko), uczelnia(Uczelnia), kierunek(Kierunek) {}
    void wczytajDane();
    void wypiszDane();
};
...
public:
    wykladowca(string Imie = "", string Nazwisko = "", string Katedra = "Katedra Informatyki", string Uczelnia = "UTH Rad.")
        : imie(Imie), nazwisko(Nazwisko), uczelnia(Uczelnia), katedra(Katedra) {}
    void wczytajDane();
    void wypiszDane();
};
